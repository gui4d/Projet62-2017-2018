...
typedef struct{
    ...
    /**la position en y de la voiture*/
    double y;
    /**la force du moteur commande par l'utilisateur suivant x*/
    double F_ax;
    /**la force du moteur commande par l'utilisateur suivant y*/
    double F_ay;
    /**la vitesse de la voiture suivant x*/
    double v_x;
    /**la vitesse de la voiture suivant y*/
    double v_y;
    /**la rotation de la voiture*/
    double rotation;
    /**vaut 1 si l'utilisateur veut freiner, 0 sinon*/
    int freinage;
    /**la force que la pente exerce suivant x*/
    double F_pentex;
    /**la force que la pente exerce suivant y*/
    double F_pentey;
} /**contient toutes les information sur la voiture dont on peut avoir besoin*/
Information;
