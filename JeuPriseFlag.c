...
void deroulement_flag_joystick(CONTEXT C,int *precedent){
    SDL_Rect positionV[C.nbjoueur], positionFlag[C.nbjoueur],initialFlag[C.nbjoueur], positionBalise[C.nbjoueur], positionCoupe;  //les positions des differents objets dont la SDL a besoin pour l'affichage
